...
addData = () =>
{
    ...
    $("#form_id").on("submit", function (e)
    {
        ...
        var d = new Date(request_date);
        var hours = d.getHours(); // => 9
        var minutues = d.getMinutes(); // =>  30
        var seconds = d.getSeconds(); // => 51

        console.log(d)

        var date_request = request_date + "T" + hours + ":" + minutues + ":" + seconds + ".000Z"
...
FilterPastDate = () =>
{
    ...
    document.getElementById("request_date").setAttribute("max", today); // "min" or "max"
}
FilterPastDate()
...
loadTable = () => 
{
    ...
    $("#data-table").dataTable({
        ...
        fnRowCallback: function (nRow, aData, iDisplayIndex, iDisplayIndexFull) 
        {
            ...
            var moment_date_request = moment(aData["request_date"]).format("LL");
