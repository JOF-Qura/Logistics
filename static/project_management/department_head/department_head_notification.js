                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            ...
                                            for (var i = 0; i < concept_paper.length; i++) {
                                                html += `<a href="/department_head/concept_paper_details/${concept_paper[i].id}" class="dropdown-item btn-notif2" data-custom-value="${concept_paper[i].id}"> <i class="fas fa-hammer mr-2"></i> <span style="white-space: normal; display: inline-block; inline-size: 250px;">Concept Paper: ${concept_paper[i].name} is requesting for approval.</span> <span class="float-right text-muted text-sm">${moment(concept_paper[i].created_at).fromNow()}</span> </a> <span class="text-muted text-sm ml-5" style="white-space: normal; display: inline-block; inline-size: 250px;">by ${concept_paper[i].concept_employee.employee_first_name + " " + concept_paper[i].concept_employee.employee_last_name}</span> <div class="dropdown-divider"></div>`
                                            }
