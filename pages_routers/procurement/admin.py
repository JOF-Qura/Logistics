...
async def user_page(request: Request):
    return templates.TemplateResponse('procurement/internal/admin/user.html',{"request": request})
...
async def user_type_page(request: Request):
    return templates.TemplateResponse('procurement/internal/admin/user_type.html',{"request": request})

@admin_user_pages.get('/procurement/employee-type/', response_class=HTMLResponse,tags=["Web Pages"])
async def user_type_page(request: Request):
    return templates.TemplateResponse('procurement/internal/admin/employee_type.html',{"request": request})

@admin_user_pages.get('/procurement/employee/', response_class=HTMLResponse,tags=["Web Pages"])
async def user_type_page(request: Request):
    return templates.TemplateResponse('procurement/internal/admin/employee.html',{"request": request})
...
async def sysadmin_page(request: Request):
    return templates.TemplateResponse('procurement/internal/admin/sysadmin.html',{"request": request})
