...
async def dashboard(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/dashboard3.html',{"request": request})
...
async def po_list(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/purchase_order_list.html',{"request": request})
...
async def pr_list(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/requisition_approval.html',{"request": request})



@p_manager_user_pages.get('/procurement/budgets/', response_class=HTMLResponse,tags=["Web Pages"])
async def budgets(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/budgets.html',{"request": request})
...
async def pr_reports(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/list_of_pr_reports.html',{"request": request})
...
async def rfq_reports(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/list_of_rfq_reports.html',{"request": request})
...
async def po_reports(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/list_of_po_reports.html',{"request": request})
...
async def vendor_reports(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/list_of_vendor_reports.html',{"request": request})
...
async def vendor_login_trail(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/vendor_login_trail.html',{"request": request})
...
async def vendor_audit_trail(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/vendor_audit_trail.html',{"request": request})
...
async def blacklist_reports(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/blacklist_reports.html',{"request": request})
...
async def invalid_login(request: Request):
    return templates.TemplateResponse('internal/procurement_manager/invalid_logins.html',{"request": request})
...
async def department(request: Request):
    return templates.TemplateResponse('internal/system_setup/department.html',{"request": request})
...
async def budget_plan_setup(request: Request):
    return templates.TemplateResponse('internal/system_setup/budget_plan.html',{"request": request})
...
async def category(request: Request):
    return templates.TemplateResponse('internal/system_setup/category.html',{"request": request})
...
async def product_page(request: Request):
    return templates.TemplateResponse('internal/system_setup/product.html',{"request": request})
