...
async def vendor_login(request: Request):
    ...
    return templates.TemplateResponse('procurement/public/vendor/vendor_login.html',{"request": request})
...
async def vendor_dashboard(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/dashboard.html',{"request": request})
...
async def vendor_rfq_services(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/rfqs_for_services.html',{"request": request})
...
async def vendor_rfq_products(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/rfqs_for_products.html',{"request": request})
...
async def vendor_proposals(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/proposals.html',{"request": request})
...
async def vendor_po(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/orders.html',{"request": request})

@vendor_user_pages.get('/vendor/reviews/', response_class=HTMLResponse,tags=["Web Pages"])
async def reviews(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/reviews.html',{"request": request})

@vendor_user_pages.get('/vendor/account/', response_class=HTMLResponse,tags=["Web Pages"])
async def vendor_account(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/vendor_account.html',{"request": request})

@vendor_user_pages.get('/vendor/invoice/', response_class=HTMLResponse,tags=["Web Pages"])
async def invoice(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/invoice.html',{"request": request})
...
async def returns(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/replacement_request.html',{"request": request})


@vendor_user_pages.get('/vendor/terms-of-reference/', response_class=HTMLResponse,tags=["Web Pages"])
async def returns(request: Request):
    return templates.TemplateResponse('procurement/public/vendor/terms_of_reference.html',{"request": request})